...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str,
                        default='Ae2d', help='the name of the model')
    parser.add_argument('--data_name', type=str,
                        default='SEUCWT', help='the name of the data')
    parser.add_argument('--data_dir', type=str,
                        default="D:\Data\Mechanical-datasets", help='the directory of the data')
    ...
    parser.add_argument('--middle_epoch', type=int,
                        default=50, help='middle number of epoch')
